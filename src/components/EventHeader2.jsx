    ...
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="flex-1 space-y-3">
        ...
        <div className="flex flex-wrap gap-3 pt-4">
          <button className="bg-gray-300 text-sm text-[black] px-4 py-2 rounded-md hover:bg-gray-400">
            Save for later
          </button>
          <button className="bg-[black] hover:black] text-white text-sm px-4 py-2 rounded-md">
            Attended
          </button>
        </div>
      </div>
